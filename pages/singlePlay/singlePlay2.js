...
var audio = new Audio('../resources/Alive.mp3');
...
const allElements = topPositionsAndKeys.map((item, index) => {
    ...
    { position: { x: 3.9, y: 0, z: 1.4 }, name: 'gourd_1', player: 1 },
    { position: { x: -2, y: 0, z: 1 }, name: 'gourd_2', player: 1 },
    { position: { x: -2.5, y: 0, z: 1.5 }, name: 'planta', player: 1 },
    { position: { x: 3.9, y: 0, z: 4 }, name: 'planta', player: 1 },
    { position: { x: -3, y: 0, z: 4 }, name: 'planta', player: 1 },
    { position: { x: -3.3, y: 0, z: 4.5 }, name: 'planta', player: 1 },
    { position: { x: -2, y: 0, z: 3.5 }, name: 'planta', player: 1 },
    { position: { x: 2.5, y: 0, z: 4 }, name: 'planta', player: 1 },
    { position: { x: 2.9, y: 0, z: 0 }, name: 'rock_2', player: 1 },
    { position: { x: -11, y: 0, z: 4 }, name: 'rock_2', player: 1 },
    { position: { x: 6, y: 0, z: 3 }, name: 'rock_2', player: 1 },
    { position: { x: -6, y: 0, z: 3 }, name: 'rock_2', player: 1 },
    { position: { x: 7, y: 0, z: 0 }, name: 'planta', player: 1 },
    { position: { x: 10.5, y: 0, z: 4.5 }, name: 'planta', player: 1 },
    //player 2 decorations
    { position: { x: 3.9, y: 0, z: 1.4 }, name: 'gourd_1', player: 2 },
    { position: { x: -2, y: 0, z: 1 }, name: 'gourd_2', player: 2 },
    { position: { x: -2.5, y: 0, z: 1.5 }, name: 'planta', player: 2 },
    { position: { x: 3.9, y: 0, z: 4 }, name: 'planta', player: 2 },
    { position: { x: -3, y: 0, z: 4 }, name: 'planta', player: 2 },
    { position: { x: -3.3, y: 0, z: 4.5 }, name: 'planta', player: 2 },
    { position: { x: -2, y: 0, z: 3.5 }, name: 'planta', player: 2 },
    { position: { x: 2.5, y: 0, z: 4 }, name: 'planta', player: 2 },
    { position: { x: 2.9, y: 0, z: 0 }, name: 'rock_2', player: 2 },
    { position: { x: -11, y: 0, z: 4 }, name: 'rock_2', player: 2 },
    { position: { x: 6, y: 0, z: 3 }, name: 'rock_2', player: 2 },
    { position: { x: -6, y: 0, z: 3 }, name: 'rock_2', player: 2 },
    { position: { x: 7, y: 0, z: 0 }, name: 'planta', player: 2 },
    { position: { x: 10.5, y: 0, z: 4.5 }, name: 'planta', player: 2 },
];
...
decorationPositions.forEach(({ position, name, player }) =>{
    Load3DModel('../resources/level2/' + name).then((object) => {
